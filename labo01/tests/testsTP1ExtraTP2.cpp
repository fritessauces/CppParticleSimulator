/**
 * @file TestsLabo2SuppLab1.cpp
 *
 * @brief Tests unitaires supplémentaire pour le code du labo01.
 *
 * Nom:
 * Code permanent :
 * Email :
...
// ===========================================================================================================
// ----- Tests supplémentaires Labo01 ------------------------------------------------------------------------
// ===========================================================================================================

TEST(TestsTP1_ExtraTP2, DotAndNorm)
{
    {
        Vector3d u;
...
TEST(TestsTP1_ExtraTP2, Transpose)
{
    {
        Matrix<double, 3, -1, ColumnStorage> m;
        m.resize(3, 18);
        m(0, 0) = -53.34082116633647;
        m(0, 1) = -46.03453300915996;
        m(0, 2) = 23.870504778711222;
        m(0, 3) = -84.38584434135912;
        m(0, 4) = 27.60925669479238;
        m(0, 5) = 12.522954739116472;
        m(0, 6) = -5.13387256788198;
        m(0, 7) = -74.64964175761908;
        m(0, 8) = 88.42295263504246;
        m(0, 9) = -86.7874919064486;
        m(0, 10) = -79.88708494735097;
        m(0, 11) = -17.17722096059542;
        m(0, 12) = 85.6897894474686;
        m(0, 13) = -82.41674556782277;
        m(0, 14) = 78.3128266236711;
        m(0, 15) = 85.25612877640819;
        m(0, 16) = -38.0873284708495;
        m(0, 17) = -58.04754165817074;
        m(1, 0) = 68.78057200370648;
        m(1, 1) = 75.90146773584507;
        m(1, 2) = 26.415843809219268;
        m(1, 3) = 85.974355132668;
        m(1, 4) = -54.547172162064996;
        m(1, 5) = -9.850761895114914;
        m(1, 6) = -20.08352800477165;
        m(1, 7) = 72.38091356402956;
        m(1, 8) = -69.22976569802486;
        m(1, 9) = -87.21077200064953;
        m(1, 10) = -87.63519136239961;
        m(1, 11) = 73.4581502775847;
        m(1, 12) = 2.53103023142846;
        m(1, 13) = -68.86709090041496;
        m(1, 14) = -58.79099188247776;
        m(1, 15) = -24.928915270896383;
        m(1, 16) = -13.203584532953869;
        m(1, 17) = 87.65227222384465;
        m(2, 0) = -11.227218979873996;
        m(2, 1) = 15.505206761251799;
        m(2, 2) = 44.279309998458956;
        m(2, 3) = 58.34181142684304;
        m(2, 4) = 1.573993682369263;
        m(2, 5) = -79.31465575205246;
        m(2, 6) = 73.20612700709674;
        m(2, 7) = 98.58368163461643;
        m(2, 8) = 71.70261300592779;
        m(2, 9) = 11.966641841584448;
        m(2, 10) = 68.6628697548895;
        m(2, 11) = 79.0263145676746;
        m(2, 12) = -82.33610024223475;
        m(2, 13) = 70.24757027549975;
        m(2, 14) = -8.685930630026036;
        m(2, 15) = 49.159487747817195;
        m(2, 16) = 24.63859030001963;
        m(2, 17) = -38.62847909657376;
        Matrix<double, -1, 3, RowStorage> mtr = m.transpose<double, -1, 3, RowStorage>();
        EXPECT_DOUBLE_EQ(mtr(0, 0), -53.34082116633647);
        EXPECT_DOUBLE_EQ(mtr(0, 1), 68.78057200370648);
        EXPECT_DOUBLE_EQ(mtr(0, 2), -11.227218979873996);
        EXPECT_DOUBLE_EQ(mtr(1, 0), -46.03453300915996);
        EXPECT_DOUBLE_EQ(mtr(1, 1), 75.90146773584507);
        EXPECT_DOUBLE_EQ(mtr(1, 2), 15.505206761251799);
        EXPECT_DOUBLE_EQ(mtr(2, 0), 23.870504778711222);
        EXPECT_DOUBLE_EQ(mtr(2, 1), 26.415843809219268);
        EXPECT_DOUBLE_EQ(mtr(2, 2), 44.279309998458956);
        EXPECT_DOUBLE_EQ(mtr(3, 0), -84.38584434135912);
        EXPECT_DOUBLE_EQ(mtr(3, 1), 85.974355132668);
        EXPECT_DOUBLE_EQ(mtr(3, 2), 58.34181142684304);
        EXPECT_DOUBLE_EQ(mtr(4, 0), 27.60925669479238);
        EXPECT_DOUBLE_EQ(mtr(4, 1), -54.547172162064996);
        EXPECT_DOUBLE_EQ(mtr(4, 2), 1.573993682369263);
        EXPECT_DOUBLE_EQ(mtr(5, 0), 12.522954739116472);
        EXPECT_DOUBLE_EQ(mtr(5, 1), -9.850761895114914);
        EXPECT_DOUBLE_EQ(mtr(5, 2), -79.31465575205246);
        EXPECT_DOUBLE_EQ(mtr(6, 0), -5.13387256788198);
        EXPECT_DOUBLE_EQ(mtr(6, 1), -20.08352800477165);
        EXPECT_DOUBLE_EQ(mtr(6, 2), 73.20612700709674);
        EXPECT_DOUBLE_EQ(mtr(7, 0), -74.64964175761908);
        EXPECT_DOUBLE_EQ(mtr(7, 1), 72.38091356402956);
        EXPECT_DOUBLE_EQ(mtr(7, 2), 98.58368163461643);
        EXPECT_DOUBLE_EQ(mtr(8, 0), 88.42295263504246);
        EXPECT_DOUBLE_EQ(mtr(8, 1), -69.22976569802486);
        EXPECT_DOUBLE_EQ(mtr(8, 2), 71.70261300592779);
        EXPECT_DOUBLE_EQ(mtr(9, 0), -86.7874919064486);
        EXPECT_DOUBLE_EQ(mtr(9, 1), -87.21077200064953);
        EXPECT_DOUBLE_EQ(mtr(9, 2), 11.966641841584448);
        EXPECT_DOUBLE_EQ(mtr(10, 0), -79.88708494735097);
        EXPECT_DOUBLE_EQ(mtr(10, 1), -87.63519136239961);
        EXPECT_DOUBLE_EQ(mtr(10, 2), 68.6628697548895);
        EXPECT_DOUBLE_EQ(mtr(11, 0), -17.17722096059542);
        EXPECT_DOUBLE_EQ(mtr(11, 1), 73.4581502775847);
        EXPECT_DOUBLE_EQ(mtr(11, 2), 79.0263145676746);
        EXPECT_DOUBLE_EQ(mtr(12, 0), 85.6897894474686);
        EXPECT_DOUBLE_EQ(mtr(12, 1), 2.53103023142846);
        EXPECT_DOUBLE_EQ(mtr(12, 2), -82.33610024223475);
        EXPECT_DOUBLE_EQ(mtr(13, 0), -82.41674556782277);
        EXPECT_DOUBLE_EQ(mtr(13, 1), -68.86709090041496);
        EXPECT_DOUBLE_EQ(mtr(13, 2), 70.24757027549975);
        EXPECT_DOUBLE_EQ(mtr(14, 0), 78.3128266236711);
        EXPECT_DOUBLE_EQ(mtr(14, 1), -58.79099188247776);
        EXPECT_DOUBLE_EQ(mtr(14, 2), -8.685930630026036);
        EXPECT_DOUBLE_EQ(mtr(15, 0), 85.25612877640819);
        EXPECT_DOUBLE_EQ(mtr(15, 1), -24.928915270896383);
        EXPECT_DOUBLE_EQ(mtr(15, 2), 49.159487747817195);
        EXPECT_DOUBLE_EQ(mtr(16, 0), -38.0873284708495);
        EXPECT_DOUBLE_EQ(mtr(16, 1), -13.203584532953869);
        EXPECT_DOUBLE_EQ(mtr(16, 2), 24.63859030001963);
        EXPECT_DOUBLE_EQ(mtr(17, 0), -58.04754165817074);
        EXPECT_DOUBLE_EQ(mtr(17, 1), 87.65227222384465);
        EXPECT_DOUBLE_EQ(mtr(17, 2), -38.62847909657376);
        Matrix<double, -1, 3, ColumnStorage> mtc = m.transpose<double, -1, 3, ColumnStorage>();
        EXPECT_DOUBLE_EQ(mtc(0, 0), -53.34082116633647);
        EXPECT_DOUBLE_EQ(mtc(0, 1), 68.78057200370648);
        EXPECT_DOUBLE_EQ(mtc(0, 2), -11.227218979873996);
        EXPECT_DOUBLE_EQ(mtc(1, 0), -46.03453300915996);
        EXPECT_DOUBLE_EQ(mtc(1, 1), 75.90146773584507);
        EXPECT_DOUBLE_EQ(mtc(1, 2), 15.505206761251799);
        EXPECT_DOUBLE_EQ(mtc(2, 0), 23.870504778711222);
        EXPECT_DOUBLE_EQ(mtc(2, 1), 26.415843809219268);
        EXPECT_DOUBLE_EQ(mtc(2, 2), 44.279309998458956);
        EXPECT_DOUBLE_EQ(mtc(3, 0), -84.38584434135912);
        EXPECT_DOUBLE_EQ(mtc(3, 1), 85.974355132668);
        EXPECT_DOUBLE_EQ(mtc(3, 2), 58.34181142684304);
        EXPECT_DOUBLE_EQ(mtc(4, 0), 27.60925669479238);
        EXPECT_DOUBLE_EQ(mtc(4, 1), -54.547172162064996);
        EXPECT_DOUBLE_EQ(mtc(4, 2), 1.573993682369263);
        EXPECT_DOUBLE_EQ(mtc(5, 0), 12.522954739116472);
        EXPECT_DOUBLE_EQ(mtc(5, 1), -9.850761895114914);
        EXPECT_DOUBLE_EQ(mtc(5, 2), -79.31465575205246);
        EXPECT_DOUBLE_EQ(mtc(6, 0), -5.13387256788198);
        EXPECT_DOUBLE_EQ(mtc(6, 1), -20.08352800477165);
        EXPECT_DOUBLE_EQ(mtc(6, 2), 73.20612700709674);
        EXPECT_DOUBLE_EQ(mtc(7, 0), -74.64964175761908);
        EXPECT_DOUBLE_EQ(mtc(7, 1), 72.38091356402956);
        EXPECT_DOUBLE_EQ(mtc(7, 2), 98.58368163461643);
        EXPECT_DOUBLE_EQ(mtc(8, 0), 88.42295263504246);
        EXPECT_DOUBLE_EQ(mtc(8, 1), -69.22976569802486);
        EXPECT_DOUBLE_EQ(mtc(8, 2), 71.70261300592779);
        EXPECT_DOUBLE_EQ(mtc(9, 0), -86.7874919064486);
        EXPECT_DOUBLE_EQ(mtc(9, 1), -87.21077200064953);
        EXPECT_DOUBLE_EQ(mtc(9, 2), 11.966641841584448);
        EXPECT_DOUBLE_EQ(mtc(10, 0), -79.88708494735097);
        EXPECT_DOUBLE_EQ(mtc(10, 1), -87.63519136239961);
        EXPECT_DOUBLE_EQ(mtc(10, 2), 68.6628697548895);
        EXPECT_DOUBLE_EQ(mtc(11, 0), -17.17722096059542);
        EXPECT_DOUBLE_EQ(mtc(11, 1), 73.4581502775847);
        EXPECT_DOUBLE_EQ(mtc(11, 2), 79.0263145676746);
        EXPECT_DOUBLE_EQ(mtc(12, 0), 85.6897894474686);
        EXPECT_DOUBLE_EQ(mtc(12, 1), 2.53103023142846);
        EXPECT_DOUBLE_EQ(mtc(12, 2), -82.33610024223475);
        EXPECT_DOUBLE_EQ(mtc(13, 0), -82.41674556782277);
        EXPECT_DOUBLE_EQ(mtc(13, 1), -68.86709090041496);
        EXPECT_DOUBLE_EQ(mtc(13, 2), 70.24757027549975);
        EXPECT_DOUBLE_EQ(mtc(14, 0), 78.3128266236711);
        EXPECT_DOUBLE_EQ(mtc(14, 1), -58.79099188247776);
        EXPECT_DOUBLE_EQ(mtc(14, 2), -8.685930630026036);
        EXPECT_DOUBLE_EQ(mtc(15, 0), 85.25612877640819);
        EXPECT_DOUBLE_EQ(mtc(15, 1), -24.928915270896383);
        EXPECT_DOUBLE_EQ(mtc(15, 2), 49.159487747817195);
        EXPECT_DOUBLE_EQ(mtc(16, 0), -38.0873284708495);
        EXPECT_DOUBLE_EQ(mtc(16, 1), -13.203584532953869);
        EXPECT_DOUBLE_EQ(mtc(16, 2), 24.63859030001963);
        EXPECT_DOUBLE_EQ(mtc(17, 0), -58.04754165817074);
        EXPECT_DOUBLE_EQ(mtc(17, 1), 87.65227222384465);
        EXPECT_DOUBLE_EQ(mtc(17, 2), -38.62847909657376);
    }
    {
        Matrix<double, 3, -1, ColumnStorage> m;
        m.resize(3, 2);
    ...
    }
    {
        ...
        m(0, 2) = -43.14614194149491;
        m(0, 3) = -40.101775141244445;
        m(0, 4) = 39.72205415555169;
        m(0, 5) = 34.48176307840737;
        m(0, 6) = -70.41477781325358;
        m(0, 7) = 31.292131242834557;
        m(0, 8) = -77.78666526803981;
        m(1, 0) = -95.74572778113553;
        m(1, 1) = 69.51734738633962;
        m(1, 2) = 35.202317107730096;
        m(1, 3) = 36.352233427548896;
        m(1, 4) = -56.947774200948565;
        m(1, 5) = -44.47310878353563;
        m(1, 6) = -52.93834327432918;
        m(1, 7) = 7.786855661378354;
        m(1, 8) = -45.40916719576622;
        m(2, 0) = 16.713951754654957;
        m(2, 1) = 62.32485766076482;
        m(2, 2) = -41.11227725909406;
        m(2, 3) = 48.40501479731836;
        m(2, 4) = -93.386341582453;
        m(2, 5) = -17.61233965622378;
        m(2, 6) = -76.82141809368453;
        m(2, 7) = -55.475406166347184;
        m(2, 8) = -71.02454570197418;
        Matrix<double, -1, 3, RowStorage> mtr = m.transpose<double, -1, 3, RowStorage>();
        EXPECT_DOUBLE_EQ(mtr(0, 0), -28.460223863032084);
        EXPECT_DOUBLE_EQ(mtr(0, 1), -95.74572778113553);
        EXPECT_DOUBLE_EQ(mtr(0, 2), 16.713951754654957);
        EXPECT_DOUBLE_EQ(mtr(1, 0), -92.25789689735883);
        EXPECT_DOUBLE_EQ(mtr(1, 1), 69.51734738633962);
        EXPECT_DOUBLE_EQ(mtr(1, 2), 62.32485766076482);
        EXPECT_DOUBLE_EQ(mtr(2, 0), -43.14614194149491);
        EXPECT_DOUBLE_EQ(mtr(2, 1), 35.202317107730096);
        EXPECT_DOUBLE_EQ(mtr(2, 2), -41.11227725909406);
        EXPECT_DOUBLE_EQ(mtr(3, 0), -40.101775141244445);
        EXPECT_DOUBLE_EQ(mtr(3, 1), 36.352233427548896);
        EXPECT_DOUBLE_EQ(mtr(3, 2), 48.40501479731836);
        EXPECT_DOUBLE_EQ(mtr(4, 0), 39.72205415555169);
        EXPECT_DOUBLE_EQ(mtr(4, 1), -56.947774200948565);
        EXPECT_DOUBLE_EQ(mtr(4, 2), -93.386341582453);
        EXPECT_DOUBLE_EQ(mtr(5, 0), 34.48176307840737);
        EXPECT_DOUBLE_EQ(mtr(5, 1), -44.47310878353563);
        EXPECT_DOUBLE_EQ(mtr(5, 2), -17.61233965622378);
        EXPECT_DOUBLE_EQ(mtr(6, 0), -70.41477781325358);
        EXPECT_DOUBLE_EQ(mtr(6, 1), -52.93834327432918);
        EXPECT_DOUBLE_EQ(mtr(6, 2), -76.82141809368453);
        EXPECT_DOUBLE_EQ(mtr(7, 0), 31.292131242834557);
        EXPECT_DOUBLE_EQ(mtr(7, 1), 7.786855661378354);
        EXPECT_DOUBLE_EQ(mtr(7, 2), -55.475406166347184);
        EXPECT_DOUBLE_EQ(mtr(8, 0), -77.78666526803981);
        EXPECT_DOUBLE_EQ(mtr(8, 1), -45.40916719576622);
        EXPECT_DOUBLE_EQ(mtr(8, 2), -71.02454570197418);
        Matrix<double, -1, 3, ColumnStorage> mtc = m.transpose<double, -1, 3, ColumnStorage>();
        EXPECT_DOUBLE_EQ(mtc(0, 0), -28.460223863032084);
        EXPECT_DOUBLE_EQ(mtc(0, 1), -95.74572778113553);
        EXPECT_DOUBLE_EQ(mtc(0, 2), 16.713951754654957);
        EXPECT_DOUBLE_EQ(mtc(1, 0), -92.25789689735883);
        EXPECT_DOUBLE_EQ(mtc(1, 1), 69.51734738633962);
        EXPECT_DOUBLE_EQ(mtc(1, 2), 62.32485766076482);
        EXPECT_DOUBLE_EQ(mtc(2, 0), -43.14614194149491);
        EXPECT_DOUBLE_EQ(mtc(2, 1), 35.202317107730096);
        EXPECT_DOUBLE_EQ(mtc(2, 2), -41.11227725909406);
        EXPECT_DOUBLE_EQ(mtc(3, 0), -40.101775141244445);
        EXPECT_DOUBLE_EQ(mtc(3, 1), 36.352233427548896);
        EXPECT_DOUBLE_EQ(mtc(3, 2), 48.40501479731836);
        EXPECT_DOUBLE_EQ(mtc(4, 0), 39.72205415555169);
        EXPECT_DOUBLE_EQ(mtc(4, 1), -56.947774200948565);
        EXPECT_DOUBLE_EQ(mtc(4, 2), -93.386341582453);
        EXPECT_DOUBLE_EQ(mtc(5, 0), 34.48176307840737);
        EXPECT_DOUBLE_EQ(mtc(5, 1), -44.47310878353563);
        EXPECT_DOUBLE_EQ(mtc(5, 2), -17.61233965622378);
        EXPECT_DOUBLE_EQ(mtc(6, 0), -70.41477781325358);
        EXPECT_DOUBLE_EQ(mtc(6, 1), -52.93834327432918);
        EXPECT_DOUBLE_EQ(mtc(6, 2), -76.82141809368453);
        EXPECT_DOUBLE_EQ(mtc(7, 0), 31.292131242834557);
        EXPECT_DOUBLE_EQ(mtc(7, 1), 7.786855661378354);
        EXPECT_DOUBLE_EQ(mtc(7, 2), -55.475406166347184);
        EXPECT_DOUBLE_EQ(mtc(8, 0), -77.78666526803981);
        EXPECT_DOUBLE_EQ(mtc(8, 1), -45.40916719576622);
        EXPECT_DOUBLE_EQ(mtc(8, 2), -71.02454570197418);
    }
    {
        Matrix<double, 3, -1, ColumnStorage> m;
        m.resize(3, 11);
    ...
    }
    {
        Matrix<double, 3, -1, ColumnStorage> m;
        m.resize(3, 4);
        m(0, 0) = 22.388181434139725;
        m(0, 1) = 93.58190844668906;
        m(0, 2) = 97.5344976392665;
        m(0, 3) = -15.951366725448551;
        m(1, 0) = 85.1299035781376;
        m(1, 1) = -45.306199650749754;
        m(1, 2) = -74.3191797133263;
        m(1, 3) = 5.358432554579821;
        m(2, 0) = -77.05101934769516;
        m(2, 1) = -41.93156826654785;
        m(2, 2) = -39.80924000570967;
        m(2, 3) = 53.52327883467342;
        Matrix<double, -1, 3, RowStorage> mtr = m.transpose<double, -1, 3, RowStorage>();
        EXPECT_DOUBLE_EQ(mtr(0, 0), 22.388181434139725);
        EXPECT_DOUBLE_EQ(mtr(0, 1), 85.1299035781376);
        EXPECT_DOUBLE_EQ(mtr(0, 2), -77.05101934769516);
        EXPECT_DOUBLE_EQ(mtr(1, 0), 93.58190844668906);
        EXPECT_DOUBLE_EQ(mtr(1, 1), -45.306199650749754);
        EXPECT_DOUBLE_EQ(mtr(1, 2), -41.93156826654785);
        EXPECT_DOUBLE_EQ(mtr(2, 0), 97.5344976392665);
        EXPECT_DOUBLE_EQ(mtr(2, 1), -74.3191797133263);
        EXPECT_DOUBLE_EQ(mtr(2, 2), -39.80924000570967);
        EXPECT_DOUBLE_EQ(mtr(3, 0), -15.951366725448551);
        EXPECT_DOUBLE_EQ(mtr(3, 1), 5.358432554579821);
        EXPECT_DOUBLE_EQ(mtr(3, 2), 53.52327883467342);
        Matrix<double, -1, 3, ColumnStorage> mtc = m.transpose<double, -1, 3, ColumnStorage>();
        EXPECT_DOUBLE_EQ(mtc(0, 0), 22.388181434139725);
        EXPECT_DOUBLE_EQ(mtc(0, 1), 85.1299035781376);
        EXPECT_DOUBLE_EQ(mtc(0, 2), -77.05101934769516);
        EXPECT_DOUBLE_EQ(mtc(1, 0), 93.58190844668906);
        EXPECT_DOUBLE_EQ(mtc(1, 1), -45.306199650749754);
        EXPECT_DOUBLE_EQ(mtc(1, 2), -41.93156826654785);
        EXPECT_DOUBLE_EQ(mtc(2, 0), 97.5344976392665);
        EXPECT_DOUBLE_EQ(mtc(2, 1), -74.3191797133263);
        EXPECT_DOUBLE_EQ(mtc(2, 2), -39.80924000570967);
        EXPECT_DOUBLE_EQ(mtc(3, 0), -15.951366725448551);
        EXPECT_DOUBLE_EQ(mtc(3, 1), 5.358432554579821);
        EXPECT_DOUBLE_EQ(mtc(3, 2), 53.52327883467342);
    }
    {
        Matrix<double, 3, -1, ColumnStorage> m;
        m.resize(3, 17);
    ...
    }
    {
        Matrix<double, 3, -1, ColumnStorage> m;
        m.resize(3, 13);
        m(0, 0) = 34.31779800584553;
        m(0, 1) = 55.012671528082535;
        m(0, 2) = -65.60345720231766;
        m(0, 3) = -49.33507330341831;
        m(0, 4) = 35.740472597306024;
        m(0, 5) = -27.244537951759142;
        m(0, 6) = -81.37232307786655;
        m(0, 7) = -87.31193616540006;
        m(0, 8) = -5.83409003190927;
        m(0, 9) = -45.378839818473146;
        m(0, 10) = 13.591067289968066;
        m(0, 11) = -1.8050737816002709;
        m(0, 12) = -10.17822356404281;
        m(1, 0) = 40.228268179061644;
        m(1, 1) = 58.01140683613005;
        m(1, 2) = 29.372511191065428;
        m(1, 3) = -37.3106613209734;
        m(1, 4) = 18.023315391960494;
        m(1, 5) = -55.244525355517226;
        m(1, 6) = 69.99758013964228;
        m(1, 7) = 82.02623771984915;
        m(1, 8) = -64.53475570928768;
        m(1, 9) = -97.60369460707761;
        m(1, 10) = -48.10912690487281;
        m(1, 11) = 16.579050141498982;
        m(1, 12) = -90.38293447062478;
        m(2, 0) = 64.59094074464039;
        m(2, 1) = -89.43102363362598;
        m(2, 2) = -17.926705119412233;
        m(2, 3) = 17.91871856018419;
        m(2, 4) = 2.0478456339645135;
        m(2, 5) = 10.226792439717272;
        m(2, 6) = 54.74936789970178;
        m(2, 7) = 9.05745310427855;
        m(2, 8) = -12.151078723792182;
        m(2, 9) = -39.87407068066251;
        m(2, 10) = -84.05092290948681;
        m(2, 11) = 22.862379023254604;
        m(2, 12) = 10.207549229939204;
        Matrix<double, -1, 3, RowStorage> mtr = m.transpose<double, -1, 3, RowStorage>();
        EXPECT_DOUBLE_EQ(mtr(0, 0), 34.31779800584553);
        EXPECT_DOUBLE_EQ(mtr(0, 1), 40.228268179061644);
        EXPECT_DOUBLE_EQ(mtr(0, 2), 64.59094074464039);
        EXPECT_DOUBLE_EQ(mtr(1, 0), 55.012671528082535);
        EXPECT_DOUBLE_EQ(mtr(1, 1), 58.01140683613005);
        EXPECT_DOUBLE_EQ(mtr(1, 2), -89.43102363362598);
        EXPECT_DOUBLE_EQ(mtr(2, 0), -65.60345720231766);
        EXPECT_DOUBLE_EQ(mtr(2, 1), 29.372511191065428);
        EXPECT_DOUBLE_EQ(mtr(2, 2), -17.926705119412233);
        EXPECT_DOUBLE_EQ(mtr(3, 0), -49.33507330341831);
        EXPECT_DOUBLE_EQ(mtr(3, 1), -37.3106613209734);
        EXPECT_DOUBLE_EQ(mtr(3, 2), 17.91871856018419);
        EXPECT_DOUBLE_EQ(mtr(4, 0), 35.740472597306024);
        EXPECT_DOUBLE_EQ(mtr(4, 1), 18.023315391960494);
        EXPECT_DOUBLE_EQ(mtr(4, 2), 2.0478456339645135);
        EXPECT_DOUBLE_EQ(mtr(5, 0), -27.244537951759142);
        EXPECT_DOUBLE_EQ(mtr(5, 1), -55.244525355517226);
        EXPECT_DOUBLE_EQ(mtr(5, 2), 10.226792439717272);
        EXPECT_DOUBLE_EQ(mtr(6, 0), -81.37232307786655);
        EXPECT_DOUBLE_EQ(mtr(6, 1), 69.99758013964228);
        EXPECT_DOUBLE_EQ(mtr(6, 2), 54.74936789970178);
        EXPECT_DOUBLE_EQ(mtr(7, 0), -87.31193616540006);
        EXPECT_DOUBLE_EQ(mtr(7, 1), 82.02623771984915);
        EXPECT_DOUBLE_EQ(mtr(7, 2), 9.05745310427855);
        EXPECT_DOUBLE_EQ(mtr(8, 0), -5.83409003190927);
        EXPECT_DOUBLE_EQ(mtr(8, 1), -64.53475570928768);
        EXPECT_DOUBLE_EQ(mtr(8, 2), -12.151078723792182);
        EXPECT_DOUBLE_EQ(mtr(9, 0), -45.378839818473146);
        EXPECT_DOUBLE_EQ(mtr(9, 1), -97.60369460707761);
        EXPECT_DOUBLE_EQ(mtr(9, 2), -39.87407068066251);
        EXPECT_DOUBLE_EQ(mtr(10, 0), 13.591067289968066);
        EXPECT_DOUBLE_EQ(mtr(10, 1), -48.10912690487281);
        EXPECT_DOUBLE_EQ(mtr(10, 2), -84.05092290948681);
        EXPECT_DOUBLE_EQ(mtr(11, 0), -1.8050737816002709);
        EXPECT_DOUBLE_EQ(mtr(11, 1), 16.579050141498982);
        EXPECT_DOUBLE_EQ(mtr(11, 2), 22.862379023254604);
        EXPECT_DOUBLE_EQ(mtr(12, 0), -10.17822356404281);
        EXPECT_DOUBLE_EQ(mtr(12, 1), -90.38293447062478);
        EXPECT_DOUBLE_EQ(mtr(12, 2), 10.207549229939204);
        Matrix<double, -1, 3, ColumnStorage> mtc = m.transpose<double, -1, 3, ColumnStorage>();
        EXPECT_DOUBLE_EQ(mtc(0, 0), 34.31779800584553);
        EXPECT_DOUBLE_EQ(mtc(0, 1), 40.228268179061644);
        EXPECT_DOUBLE_EQ(mtc(0, 2), 64.59094074464039);
        EXPECT_DOUBLE_EQ(mtc(1, 0), 55.012671528082535);
        EXPECT_DOUBLE_EQ(mtc(1, 1), 58.01140683613005);
        EXPECT_DOUBLE_EQ(mtc(1, 2), -89.43102363362598);
        EXPECT_DOUBLE_EQ(mtc(2, 0), -65.60345720231766);
        EXPECT_DOUBLE_EQ(mtc(2, 1), 29.372511191065428);
        EXPECT_DOUBLE_EQ(mtc(2, 2), -17.926705119412233);
        EXPECT_DOUBLE_EQ(mtc(3, 0), -49.33507330341831);
        EXPECT_DOUBLE_EQ(mtc(3, 1), -37.3106613209734);
        EXPECT_DOUBLE_EQ(mtc(3, 2), 17.91871856018419);
        EXPECT_DOUBLE_EQ(mtc(4, 0), 35.740472597306024);
        EXPECT_DOUBLE_EQ(mtc(4, 1), 18.023315391960494);
        EXPECT_DOUBLE_EQ(mtc(4, 2), 2.0478456339645135);
        EXPECT_DOUBLE_EQ(mtc(5, 0), -27.244537951759142);
        EXPECT_DOUBLE_EQ(mtc(5, 1), -55.244525355517226);
        EXPECT_DOUBLE_EQ(mtc(5, 2), 10.226792439717272);
        EXPECT_DOUBLE_EQ(mtc(6, 0), -81.37232307786655);
        EXPECT_DOUBLE_EQ(mtc(6, 1), 69.99758013964228);
        EXPECT_DOUBLE_EQ(mtc(6, 2), 54.74936789970178);
        EXPECT_DOUBLE_EQ(mtc(7, 0), -87.31193616540006);
        EXPECT_DOUBLE_EQ(mtc(7, 1), 82.02623771984915);
        EXPECT_DOUBLE_EQ(mtc(7, 2), 9.05745310427855);
        EXPECT_DOUBLE_EQ(mtc(8, 0), -5.83409003190927);
        EXPECT_DOUBLE_EQ(mtc(8, 1), -64.53475570928768);
        EXPECT_DOUBLE_EQ(mtc(8, 2), -12.151078723792182);
        EXPECT_DOUBLE_EQ(mtc(9, 0), -45.378839818473146);
        EXPECT_DOUBLE_EQ(mtc(9, 1), -97.60369460707761);
        EXPECT_DOUBLE_EQ(mtc(9, 2), -39.87407068066251);
        EXPECT_DOUBLE_EQ(mtc(10, 0), 13.591067289968066);
        EXPECT_DOUBLE_EQ(mtc(10, 1), -48.10912690487281);
        EXPECT_DOUBLE_EQ(mtc(10, 2), -84.05092290948681);
        EXPECT_DOUBLE_EQ(mtc(11, 0), -1.8050737816002709);
        EXPECT_DOUBLE_EQ(mtc(11, 1), 16.579050141498982);
        EXPECT_DOUBLE_EQ(mtc(11, 2), 22.862379023254604);
        EXPECT_DOUBLE_EQ(mtc(12, 0), -10.17822356404281);
        EXPECT_DOUBLE_EQ(mtc(12, 1), -90.38293447062478);
        EXPECT_DOUBLE_EQ(mtc(12, 2), 10.207549229939204);
    }
}

TEST(TestsTP1_ExtraTP2, AffectationBySubMatrix)
{
...
TEST(TestsTP1_ExtraTP2, ProductMatrixMatrix)
{
    {
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = -42.85853815815028;
        m33(0, 1) = 66.54907256064595;
        m33(0, 2) = 88.20800998997993;
        m33(1, 0) = 78.78655471073938;
        m33(1, 1) = -93.23301540329196;
        m33(1, 2) = -7.765917970369074;
        m33(2, 0) = -68.83995705708816;
        m33(2, 1) = 95.7827812371988;
        m33(2, 2) = 55.56967487929728;
        Matrix<double, 3, -1, ColumnStorage> m3n;
        m3n.resize(3, 17);
        m3n(0, 0) = 98.84849177151472;
        m3n(0, 1) = 7.616459277345598;
        m3n(0, 2) = -66.25405738311306;
        m3n(0, 3) = 23.168945978514714;
        m3n(0, 4) = 43.111670478613064;
        m3n(0, 5) = -91.26472722151308;
        m3n(0, 6) = 58.799921549502045;
        m3n(0, 7) = -79.00590009301997;
        m3n(0, 8) = 8.175644916169446;
        m3n(0, 9) = -9.246750810010894;
        m3n(0, 10) = -92.31747578992069;
        m3n(0, 11) = -77.14763902860831;
        m3n(0, 12) = 30.60013582619169;
        m3n(0, 13) = -81.21738381059589;
        m3n(0, 14) = 9.01104917267756;
        m3n(0, 15) = 69.8520925048092;
        m3n(0, 16) = -68.44398850399287;
        m3n(1, 0) = 91.06123834199835;
        m3n(1, 1) = 88.26282996012128;
        m3n(1, 2) = -78.19439306157841;
        m3n(1, 3) = 85.31799207676045;
        m3n(1, 4) = 98.39056524349868;
        m3n(1, 5) = 50.66397250379288;
        m3n(1, 6) = -38.178869856553874;
        m3n(1, 7) = 46.914583875717454;
        m3n(1, 8) = -57.64634980444183;
        m3n(1, 9) = -85.23707366097094;
        m3n(1, 10) = -58.73432466348816;
        m3n(1, 11) = -97.11588169308361;
        m3n(1, 12) = 91.37234777548545;
        m3n(1, 13) = -15.305838304523945;
        m3n(1, 14) = -54.32748707938187;
        m3n(1, 15) = 63.25957176670843;
        m3n(1, 16) = -20.157582821972;
        m3n(2, 0) = -55.37589619232166;
        m3n(2, 1) = -85.19018928563406;
        m3n(2, 2) = 65.07835681188135;
        m3n(2, 3) = -45.12845473673901;
        m3n(2, 4) = 55.97276353112065;
        m3n(2, 5) = -65.21832541713073;
        m3n(2, 6) = -95.45291500172213;
        m3n(2, 7) = -66.39650172855067;
        m3n(2, 8) = 43.89239679211968;
        m3n(2, 9) = 97.4566997349209;
        m3n(2, 10) = -65.4978919639202;
        m3n(2, 11) = -9.960700506808678;
        m3n(2, 12) = 49.88010716382348;
        m3n(2, 13) = -7.9972564273441265;
        m3n(2, 14) = 65.31402843529702;
        m3n(2, 15) = -65.64401302836522;
        m3n(2, 16) = -77.78229500169263;
        Matrix<double, -1, 3, ColumnStorage> mn3;
        mn3.resize(17, 3);
        mn3(0, 0) = -70.06495803116024;
        mn3(0, 1) = -38.4052971681502;
        mn3(0, 2) = 70.00505328857432;
        mn3(1, 0) = -7.712731705623426;
        mn3(1, 1) = 96.2504558520979;
        mn3(1, 2) = 68.21833316488889;
        mn3(2, 0) = -52.365205166752645;
        mn3(2, 1) = 93.5774089480552;
        mn3(2, 2) = 55.0627474373438;
        mn3(3, 0) = -37.35275380230454;
        mn3(3, 1) = -98.75396899795616;
        mn3(3, 2) = -41.33822205424082;
        mn3(4, 0) = 5.532115269200162;
        mn3(4, 1) = -47.86474218475245;
        mn3(4, 2) = -19.75569424708938;
        mn3(5, 0) = -71.4996663689414;
        mn3(5, 1) = -69.79079068760774;
        mn3(5, 2) = -53.30539201408524;
        mn3(6, 0) = -90.72900451637426;
        mn3(6, 1) = 58.60873643632874;
        mn3(6, 2) = -47.47421380061001;
        mn3(7, 0) = 90.31636261457794;
        mn3(7, 1) = -31.085103323381702;
        mn3(7, 2) = 16.60245817495023;
        mn3(8, 0) = -0.3433411187488531;
        mn3(8, 1) = 78.20068622396025;
        mn3(8, 2) = -74.283846658339;
        mn3(9, 0) = -65.3376828056848;
        mn3(9, 1) = 52.148554540439505;
        mn3(9, 2) = 97.05571085188092;
        mn3(10, 0) = -18.161241511542286;
        mn3(10, 1) = 79.57012773110202;
        mn3(10, 2) = -51.97347813795974;
        mn3(11, 0) = -30.3051081489661;
        mn3(11, 1) = 61.43661493037595;
        mn3(11, 2) = 3.182556381678367;
        mn3(12, 0) = 0.29231377711404605;
        mn3(12, 1) = -77.8737699159633;
        mn3(12, 2) = 90.21085369002415;
        mn3(13, 0) = 76.36781301329302;
        mn3(13, 1) = -49.9298460978546;
        mn3(13, 2) = -59.56374099116963;
        mn3(14, 0) = -86.73178311153507;
        mn3(14, 1) = -72.46273083964854;
        mn3(14, 2) = 87.70236334913108;
        mn3(15, 0) = -69.97691465430029;
        mn3(15, 1) = -6.083155148477289;
        mn3(15, 2) = 67.14950349479145;
        mn3(16, 0) = -4.539481426385606;
        mn3(16, 1) = -35.20945344901385;
        mn3(16, 2) = 29.294188819583127;
    ...
    {
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = 83.43418160115675;
        m33(0, 1) = -44.22588669239988;
        m33(0, 2) = 68.25021983082604;
        m33(1, 0) = -79.62901156336082;
        m33(1, 1) = -24.457448558278756;
        m33(1, 2) = 70.53678443361443;
        m33(2, 0) = -14.4144840341188;
        m33(2, 1) = -13.109846066792016;
        m33(2, 2) = 82.37875945025877;
        Matrix<double, 3, -1, ColumnStorage> m3n;
        m3n.resize(3, 10);
        m3n(0, 0) = -48.62443660946782;
        m3n(0, 1) = 98.11359341012644;
        m3n(0, 2) = -2.808187060457044;
        m3n(0, 3) = 48.367831590297925;
        m3n(0, 4) = 20.718823921747827;
        m3n(0, 5) = -15.974119404669395;
        m3n(0, 6) = -15.182001543493627;
        m3n(0, 7) = -34.20173512456826;
        m3n(0, 8) = 45.74973718511376;
        m3n(0, 9) = 76.68294886484051;
        m3n(1, 0) = 88.65710783758146;
        m3n(1, 1) = -98.45973218127433;
        m3n(1, 2) = 2.424684538053185;
        m3n(1, 3) = 20.68840625351571;
        m3n(1, 4) = 53.53371648631625;
        m3n(1, 5) = -32.93466067778516;
        m3n(1, 6) = 92.146212009326;
        m3n(1, 7) = 25.51085919145399;
        m3n(1, 8) = 43.015739514779966;
        m3n(1, 9) = -34.74673727634277;
        m3n(2, 0) = -85.25567920912924;
        m3n(2, 1) = 92.3441805996942;
        m3n(2, 2) = -26.113505762348453;
        m3n(2, 3) = -29.372384225036896;
        m3n(2, 4) = 45.89609572062153;
        m3n(2, 5) = 45.83125862400976;
        m3n(2, 6) = -31.494552210426832;
        m3n(2, 7) = 25.41679278089562;
        m3n(2, 8) = -14.780156364881833;
        m3n(2, 9) = -23.69804647869465;
        Matrix<double, -1, 3, ColumnStorage> mn3;
        mn3.resize(10, 3);
        mn3(0, 0) = -61.82152702094024;
        mn3(0, 1) = -83.432982804468;
        mn3(0, 2) = 70.25344716791878;
        mn3(1, 0) = 6.517898058100229;
        mn3(1, 1) = -52.65708646818727;
        mn3(1, 2) = 6.238799074556667;
        mn3(2, 0) = -6.242760888536324;
        mn3(2, 1) = 53.50897861440629;
        mn3(2, 2) = -81.51297686179959;
        mn3(3, 0) = 87.02845297184587;
        mn3(3, 1) = -43.76220730453782;
        mn3(3, 2) = 61.46217169482554;
        mn3(4, 0) = 28.905294338736155;
        mn3(4, 1) = -53.97768161511518;
        mn3(4, 2) = -25.55611791367916;
        mn3(5, 0) = -97.00959474301645;
        mn3(5, 1) = -50.75647429646901;
        mn3(5, 2) = -92.87137126950047;
        mn3(6, 0) = -26.01116465035433;
        mn3(6, 1) = 68.69912155029814;
        mn3(6, 2) = -27.680352707754068;
        mn3(7, 0) = -3.0040376744443478;
        mn3(7, 1) = 23.47084622717594;
        mn3(7, 2) = -95.7304466018079;
        mn3(8, 0) = 55.55896199260414;
        mn3(8, 1) = -52.903603854543626;
        mn3(8, 2) = -88.71999600476343;
        mn3(9, 0) = -94.87264283519269;
        mn3(9, 1) = 42.051846079602484;
    ...
    {
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = 81.84758582945432;
        m33(0, 1) = 79.21502926741178;
        m33(0, 2) = -46.36545422961669;
        m33(1, 0) = 61.67190010409536;
        m33(1, 1) = -38.5901489121749;
        m33(1, 2) = -59.678134300371944;
        m33(2, 0) = -34.47167396842592;
        m33(2, 1) = -87.98604544462401;
        m33(2, 2) = 94.53517522102999;
        Matrix<double, 3, -1, ColumnStorage> m3n;
        m3n.resize(3, 18);
        m3n(0, 0) = -73.91580925065236;
        m3n(0, 1) = -52.14744304510241;
        m3n(0, 2) = 9.169231467565382;
        m3n(0, 3) = -28.50576278223346;
        m3n(0, 4) = 67.34464767793972;
        m3n(0, 5) = -34.684121347380454;
        m3n(0, 6) = -61.15526409760825;
        m3n(0, 7) = 99.09243185307338;
        m3n(0, 8) = -30.516609564391302;
        m3n(0, 9) = 68.71860642362694;
        m3n(0, 10) = 29.009301443176923;
        m3n(0, 11) = -49.24190237569428;
        m3n(0, 12) = 50.53439589982935;
        m3n(0, 13) = -77.02250847202401;
        m3n(0, 14) = -0.05051377915768285;
        m3n(0, 15) = 41.19793449683681;
        m3n(0, 16) = 60.8799382872773;
        m3n(0, 17) = -1.7098764116632736;
        m3n(1, 0) = 72.18924333031939;
        m3n(1, 1) = 86.08785975954777;
        m3n(1, 2) = 66.09706041661047;
        m3n(1, 3) = 21.608137349663536;
        m3n(1, 4) = 83.82256848332821;
        m3n(1, 5) = 16.44885873077135;
        m3n(1, 6) = -14.507808421127933;
        m3n(1, 7) = 19.55337477581469;
        m3n(1, 8) = -75.01590976841727;
        m3n(1, 9) = -92.59846934030813;
        m3n(1, 10) = 68.53325732458515;
        m3n(1, 11) = -34.89001188866443;
        m3n(1, 12) = -45.2883099226425;
        m3n(1, 13) = -92.3013673337336;
        m3n(1, 14) = 62.657125254362626;
        m3n(1, 15) = 42.76723013196133;
        m3n(1, 16) = 52.068828592168984;
        m3n(1, 17) = 63.43597336979934;
        m3n(2, 0) = 16.44946758401109;
        m3n(2, 1) = -15.100505519485765;
        m3n(2, 2) = 33.525440741947534;
        m3n(2, 3) = -16.849394714264207;
        m3n(2, 4) = -65.78832954926979;
        m3n(2, 5) = 45.98172472055896;
        m3n(2, 6) = -67.11063023807395;
        m3n(2, 7) = 7.924149998325518;
        m3n(2, 8) = -20.93195510208639;
        m3n(2, 9) = 16.985037957135546;
        m3n(2, 10) = -95.32996649895755;
        m3n(2, 11) = 41.501154967135164;
        m3n(2, 12) = 58.82684982043526;
        m3n(2, 13) = 3.2303065481773956;
        m3n(2, 14) = 28.652037233534116;
        m3n(2, 15) = -60.44952644648844;
        m3n(2, 16) = 19.668763678818962;
        m3n(2, 17) = 57.66895215528987;
        Matrix<double, -1, 3, ColumnStorage> mn3;
        mn3.resize(18, 3);
        mn3(0, 0) = 72.03481060848608;
        mn3(0, 1) = -12.370116255229789;
        mn3(0, 2) = -71.33220049059176;
        mn3(1, 0) = 74.82288990046416;
        mn3(1, 1) = 24.951894706717212;
        mn3(1, 2) = -44.011203285979825;
        mn3(2, 0) = -96.19012694563449;
        mn3(2, 1) = 97.50109556697262;
        mn3(2, 2) = 6.212993899936919;
        mn3(3, 0) = 60.68874561643241;
        mn3(3, 1) = -29.122147514554953;
        mn3(3, 2) = 13.32731011674737;
        mn3(4, 0) = -97.54748261221557;
        mn3(4, 1) = -63.60924708719817;
        mn3(4, 2) = 15.004667663748734;
        mn3(5, 0) = 7.30878678364671;
        mn3(5, 1) = -55.479738541366096;
        mn3(5, 2) = 79.90269442370936;
        mn3(6, 0) = -73.31481779159685;
        mn3(6, 1) = -63.7978492458229;
        mn3(6, 2) = -85.10463852461893;
        mn3(7, 0) = -89.55215688583478;
        mn3(7, 1) = 31.465026309608504;
        mn3(7, 2) = -68.65841116768527;
        mn3(8, 0) = -0.5623403930786708;
        mn3(8, 1) = 9.257213861938965;
        mn3(8, 2) = -46.354519140450876;
        mn3(9, 0) = -83.67730694202329;
        mn3(9, 1) = -76.41848091535546;
        mn3(9, 2) = -90.50462095774347;
        mn3(10, 0) = 46.593866425888564;
        mn3(10, 1) = -88.46388973875636;
        mn3(10, 2) = -53.2925446993026;
        mn3(11, 0) = -48.06532296671442;
        mn3(11, 1) = 16.025057666153586;
        mn3(11, 2) = -85.24695217563412;
        mn3(12, 0) = -3.9803779015100673;
        mn3(12, 1) = 27.74268584169073;
        mn3(12, 2) = -33.75555087303026;
        mn3(13, 0) = 33.47705472771614;
        mn3(13, 1) = -37.76977798106018;
        mn3(13, 2) = 81.8162877816591;
        mn3(14, 0) = -23.627266722981304;
        mn3(14, 1) = -90.97908271575793;
        mn3(14, 2) = 73.62101811945178;
        mn3(15, 0) = -41.6713855485237;
        mn3(15, 1) = -57.329385199457896;
        mn3(15, 2) = 12.979363076026544;
        mn3(16, 0) = -79.88438132214077;
        mn3(16, 1) = -93.98179933537551;
        mn3(16, 2) = 75.64708901925817;
        mn3(17, 0) = -27.207833502955054;
...
TEST(TestsTP1_ExtraTP2, ProductMatrixVector)
{
    {
        Vector<double, 3> u;
        u(0) = 89.63885274026418;
        u(1) = 33.98267508829284;
        u(2) = 58.18085749457168;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = -37.761291293282206;
        m33(0, 1) = -58.77833883088219;
        m33(0, 2) = -80.31292383738193;
        m33(1, 0) = 82.42200051847567;
        m33(1, 1) = -21.616077216647483;
        m33(1, 2) = -81.41765352024458;
        m33(2, 0) = -1.826095889555674;
        m33(2, 1) = -72.65845670305742;
        m33(2, 2) = -68.43559055076148;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = -0.6810804556978075;
        m44(0, 1) = -0.3717461369121619;
        m44(0, 2) = -0.6308202775413543;
        m44(0, 3) = 65.25663257716863;
        m44(1, 0) = -0.7322085856273928;
        m44(1, 1) = 0.3457881173505905;
        m44(1, 2) = 0.5867718168356992;
        m44(1, 3) = -72.82746334890318;
        m44(2, 0) = 0.0;
        m44(2, 1) = 0.8615308396047228;
        m44(2, 2) = -0.5077052416609282;
        m44(2, 3) = -50.951590508183095;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
    ...
    {
        Vector<double, 3> u;
        u(0) = 21.26102327359945;
        u(1) = -63.632003812151375;
        u(2) = 21.749676556807557;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = -72.46587508929531;
        m33(0, 1) = 26.74413795088728;
        m33(0, 2) = 66.40155978725781;
        m33(1, 0) = 30.554539344667063;
        m33(1, 1) = 34.707428553000256;
        m33(1, 2) = -78.73225643210714;
        m33(2, 0) = 29.88002386285075;
        m33(2, 1) = 84.40743250651678;
        m33(2, 2) = 89.33116036637102;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = -0.8156253236747055;
        m44(0, 1) = 0.0;
        m44(0, 2) = 0.5785804450381398;
        m44(0, 3) = -36.44550865077372;
        m44(1, 0) = -0.4886547783002762;
        m44(1, 1) = 0.5354367269787551;
        m44(1, 2) = -0.6888570381774334;
        m44(1, 3) = 26.24571159164249;
        m44(2, 0) = -0.3097932197851331;
        m44(2, 1) = -0.8445753438280554;
        m44(2, 2) = -0.43671575374937205;
        m44(2, 3) = 58.09911341828064;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
    ...
    {
        Vector<double, 3> u;
        u(0) = 60.89920397428068;
        u(1) = 41.99263628824008;
        u(2) = 2.8397811977043403;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = 37.756340946034896;
        m33(0, 1) = 34.695096214807364;
        m33(0, 2) = 71.82563147437446;
        m33(1, 0) = 74.91874228380777;
        m33(1, 1) = 11.371524438829937;
        m33(1, 2) = 22.662878030996694;
        m33(2, 0) = -33.183135422386044;
        m33(2, 1) = -48.81237469926953;
        m33(2, 2) = 77.28631280104915;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = 0.09071108841607319;
        m44(0, 1) = 0.15875989354807826;
        m44(0, 2) = -0.9831412892555038;
        m44(0, 3) = -20.28034322391565;
        m44(1, 0) = 0.8682639927927074;
        m44(1, 1) = -0.49610244790735053;
        m44(1, 2) = 0.0;
        m44(1, 3) = -65.91591665493024;
        m44(2, 0) = -0.487738800238444;
        m44(2, 1) = -0.8536261812883538;
        m44(2, 2) = -0.18284749208295362;
        m44(2, 3) = -28.08938117342305;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
    ...
    {
        Vector<double, 3> u;
        u(0) = 5.188467455547638;
        u(1) = 18.80451508110363;
        u(2) = -21.656727889135595;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = 87.9457818703861;
        m33(0, 1) = 73.05874068692381;
        m33(0, 2) = 39.940251688233246;
        m33(1, 0) = 75.10237717805055;
        m33(1, 1) = 72.18489393198146;
        m33(1, 2) = 99.55423077694917;
        m33(2, 0) = -23.406607601688265;
        m33(2, 1) = 36.642344803461384;
        m33(2, 2) = 59.655570064408465;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = 0.17067228277067772;
        m44(0, 1) = -0.6737686724718157;
        m44(0, 2) = -0.7189622715340582;
        m44(0, 3) = -18.335201879756795;
        m44(1, 0) = -0.9693828421385298;
        m44(1, 1) = -0.24555428191629253;
        m44(1, 2) = 0.0;
        m44(1, 3) = 29.845708309352148;
        m44(2, 0) = -0.1765442643114522;
        m44(2, 1) = 0.6969496901700587;
        m44(2, 2) = -0.6950491005034012;
        m44(2, 3) = -31.894796135192152;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
    ...
    {
        Vector<double, 3> u;
        u(0) = 37.47349664672282;
        u(1) = -60.74514266373965;
        u(2) = -40.46471876369226;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = -18.595918421354753;
        m33(0, 1) = -63.34971612297557;
        m33(0, 2) = 51.78315639657973;
        m33(1, 0) = 60.68830258069576;
        m33(1, 1) = -63.44130757420927;
        m33(1, 2) = 0.1227343978225548;
        m33(2, 0) = 69.14823593166864;
        m33(2, 1) = 49.45675635266332;
        m33(2, 2) = 81.76280170074256;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = -0.250151688477416;
        m44(0, 1) = -0.2581347286114716;
        m44(0, 2) = -0.9331616122819132;
        m44(0, 3) = 15.902624286413442;
        m44(1, 0) = -0.7181238873483027;
        m44(1, 1) = 0.6959152839389017;
        m44(1, 2) = 0.0;
        m44(1, 3) = -12.358184768214258;
        m44(2, 0) = 0.6494014283720508;
        m44(2, 1) = 0.6701256445360971;
        m44(2, 2) = -0.3594570980846258;
        m44(2, 3) = -95.12313555065694;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
    ...
    {
        Vector<double, 3> u;
        u(0) = -18.242981648343232;
        u(1) = 56.21809486615007;
        u(2) = 68.42388784251386;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = 72.32617531563085;
        m33(0, 1) = 16.921578626504015;
        m33(0, 2) = -27.34080821434577;
        m33(1, 0) = 75.31926937290174;
        m33(1, 1) = -81.4337114340538;
        m33(1, 2) = 49.516021610363254;
        m33(2, 0) = 40.651084247784695;
        m33(2, 1) = -19.615350275581747;
        m33(2, 2) = 96.61096468197644;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = 0.8628144975844739;
        m44(0, 1) = -0.39604187777629973;
        m44(0, 2) = 0.3141687027784186;
        m44(0, 3) = -15.592609294116613;
        m44(1, 0) = -0.5055206650158348;
        m44(1, 1) = -0.6759578736217757;
        m44(1, 2) = 0.5362180622943203;
        m44(1, 3) = 10.857285613068584;
        m44(2, 0) = 0.0;
        m44(2, 1) = -0.6214754895699024;
        m44(2, 2) = -0.7834336065448367;
        m44(2, 3) = -95.09026591014809;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
    ...
    {
        Vector<double, 3> u;
        u(0) = -59.27939726364973;
        u(1) = 96.57872437189005;
        u(2) = -50.71931054476342;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = -53.51188145034156;
        m33(0, 1) = -39.773533094835024;
        m33(0, 2) = -81.91533947789623;
        m33(1, 0) = -48.98656664587613;
        m33(1, 1) = -30.35481126192778;
        m33(1, 2) = -24.41812181189411;
        m33(2, 0) = 50.987332445586844;
        m33(2, 1) = -15.614790715203753;
        m33(2, 2) = 1.953005394977339;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = -0.9781360701985449;
        m44(0, 1) = 0.0;
        m44(0, 2) = -0.20796593032645286;
        m44(0, 3) = 31.079492180635583;
        m44(1, 0) = 0.17988007252338098;
        m44(1, 1) = 0.5018585333987298;
        m44(1, 2) = -0.846038516832336;
        m44(1, 3) = 89.95140758767585;
        m44(2, 0) = 0.10436947679053606;
        m44(2, 1) = -0.8649497167205016;
        m44(2, 2) = -0.4908859336542387;
        m44(2, 3) = -66.61272043333199;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
    ...
    {
        Vector<double, 3> u;
        u(0) = -33.64679408120854;
        u(1) = 57.74585710730173;
        u(2) = -38.78100535372986;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = -48.76215910463826;
        m33(0, 1) = -17.88064937607517;
        m33(0, 2) = -10.666843689761578;
        m33(1, 0) = 54.129177432133815;
        m33(1, 1) = -50.3409670888066;
        m33(1, 2) = 67.92880818886752;
        m33(2, 0) = -36.14536761608753;
        m33(2, 1) = 92.53432169416001;
        m33(2, 2) = 68.69365938680332;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = 0.4751126538005149;
        m44(0, 1) = 0.5241078534879362;
        m44(0, 2) = -0.7068089728568109;
        m44(0, 3) = 7.21266115268952;
        m44(1, 0) = -0.7408885299063788;
        m44(1, 1) = 0.671628011813954;
        m44(1, 2) = 0.0;
        m44(1, 3) = -99.71424185587028;
        m44(2, 0) = 0.4747127051720829;
        m44(2, 1) = 0.5236666608245202;
        m44(2, 2) = 0.7074044641427562;
        m44(2, 3) = -11.057694172067542;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
    ...
    {
        Vector<double, 3> u;
        u(0) = 15.282052878141911;
        u(1) = -2.259998336973041;
        u(2) = 91.08586195638563;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = -88.39582865245377;
        m33(0, 1) = -64.58071224128338;
        m33(0, 2) = -4.675696828923634;
        m33(1, 0) = -86.1584474938788;
        m33(1, 1) = -34.543435043656444;
        m33(1, 2) = -62.495745585883625;
        m33(2, 0) = -59.183456388092395;
        m33(2, 1) = -57.14307430989349;
        m33(2, 2) = 44.41751022537625;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = 0.44386855289227883;
        m44(0, 1) = 0.5950916475208161;
        m44(0, 2) = 0.6699601770286612;
        m44(0, 3) = -72.72024311218823;
        m44(1, 0) = -0.8960919080949868;
        m44(1, 1) = 0.29477162558569525;
        m44(1, 2) = 0.33185686823727545;
        m44(1, 3) = 15.476209050615353;
        m44(2, 0) = 0.0;
        m44(2, 1) = -0.7476467212531113;
        m44(2, 2) = 0.6640966648007446;
        m44(2, 3) = 99.8824543736142;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
    ...
    {
        Vector<double, 3> u;
        u(0) = -45.53190350588168;
        u(1) = 98.18869916536156;
        u(2) = 82.67567746788419;
        Matrix<double, 3, 3, ColumnStorage> m33;
        m33(0, 0) = -51.297389589304785;
        m33(0, 1) = -66.59459838930371;
        m33(0, 2) = 27.56805306675247;
        m33(1, 0) = 96.48690448918092;
        m33(1, 1) = 9.10079699500524;
        m33(1, 2) = 83.88487605323621;
        m33(2, 0) = 41.570057963368356;
        m33(2, 1) = 24.52264689542079;
        m33(2, 2) = -76.44940699537474;
        Matrix<double, 4, 4, ColumnStorage> m44;
        m44(0, 0) = 0.774965095070908;
        m44(0, 1) = 0.0;
        m44(0, 2) = 0.6320040359220331;
        m44(0, 3) = -94.78257020280037;
        m44(1, 0) = -0.5539089538751407;
        m44(1, 1) = 0.4815245168438749;
        m44(1, 2) = 0.6792046896887713;
        m44(1, 3) = 63.87247725975902;
        m44(2, 0) = -0.3043254380407359;
        m44(2, 1) = -0.8764326212997054;
        m44(2, 2) = 0.3731646929748866;
        m44(2, 3) = -95.85244653326883;
        m44(3, 0) = 0.0;
        m44(3, 1) = 0.0;
        m44(3, 2) = 0.0;
        m44(3, 3) = 1.0;
...
TEST(TestsTP1_ExtraTP2, RigidTransformInverse)
{
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = -0.7899179842354741;
        m(0, 1) = 0.5558875173441905;
        m(0, 2) = 0.2588795979645317;
        m(0, 3) = 63.53646575655944;
        m(1, 0) = -0.6132125065435026;
        m(1, 1) = -0.7160740240561843;
        m(1, 2) = -0.3334792555626483;
        m(1, 3) = 46.40415080808421;
        m(2, 0) = 0.0;
        m(2, 1) = -0.4221694684991984;
        m(2, 2) = 0.9065169275127214;
        m(2, 3) = 37.91755407005138;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
    ...
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = 0.6589112893907124;
        m(0, 1) = -0.32720889915223983;
        m(0, 2) = 0.6773258071482646;
        m(0, 3) = -47.579657162583366;
        m(1, 0) = -0.7522206542720485;
        m(1, 1) = -0.2866202043457096;
        m(1, 2) = 0.5933067888937011;
        m(1, 3) = 30.029355381737275;
        m(2, 0) = 0.0;
        m(2, 1) = -0.9004350030826229;
        m(2, 2) = -0.4349905806147956;
        m(2, 3) = 80.66547089822612;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
    ...
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = -0.12921677297502387;
        m(0, 1) = 0.0;
        m(0, 2) = -0.9916163701663668;
        m(0, 3) = -85.67624239250289;
        m(1, 0) = 0.5536164401240612;
        m(1, 1) = -0.8296411663169171;
        m(1, 2) = -0.07214133611645579;
        m(1, 3) = -80.61895745285052;
        m(2, 0) = -0.8226857618837724;
        m(2, 1) = -0.5582969954713223;
        m(2, 2) = 0.1072035542387071;
        m(2, 3) = -59.16846832515195;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
    ...
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = 0.6178488588834932;
        m(0, 1) = 0.656563779114608;
        m(0, 2) = 0.4326508887441579;
        m(0, 3) = -3.573389719025613;
        m(1, 0) = -0.7862968825935693;
        m(1, 1) = 0.5159084191865928;
        m(1, 2) = 0.33996428553015007;
        m(1, 3) = 9.98340634305292;
        m(2, 0) = 0.0;
        m(2, 1) = -0.5502385909468138;
        m(2, 2) = 0.8350074808244923;
        m(2, 3) = 57.03623931292819;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
    ...
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = -0.30532791727234754;
        m(0, 1) = 0.42993321248800975;
        m(0, 2) = -0.8496659906892062;
        m(0, 3) = -4.900019523419871;
        m(1, 0) = -0.9522472698486095;
        m(1, 1) = -0.13785349298616878;
        m(1, 2) = 0.272436325656807;
        m(1, 3) = 61.254180348498465;
        m(2, 0) = 0.0;
        m(2, 1) = 0.8922745358191345;
        m(2, 2) = 0.45149324771113447;
        m(2, 3) = 41.98722428204593;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
    ...
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = -0.8426665329724763;
        m(0, 1) = -0.13329457405486883;
        m(0, 2) = 0.5216758291656588;
        m(0, 3) = 54.75958681320196;
        m(1, 0) = -0.5384358032376251;
        m(1, 1) = 0.20860959822407732;
        m(1, 2) = -0.81643672217793;
        m(1, 3) = 91.96965943681118;
        m(2, 0) = 0.0;
        m(2, 1) = -0.9688728461755547;
        m(2, 2) = -0.24755889792871488;
        m(2, 3) = 99.00199341303772;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
    ...
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = -0.7135830808790772;
        m(0, 1) = 0.0;
        m(0, 2) = -0.7005706150582712;
        m(0, 3) = 46.98894352455778;
        m(1, 0) = 0.5815768734392242;
        m(1, 1) = 0.5575439866421585;
        m(1, 2) = -0.5923791380862643;
        m(1, 3) = -32.31315706340996;
        m(2, 0) = 0.39059893364393755;
        m(2, 1) = -0.8301473983330724;
        m(2, 2) = -0.39785395571371457;
        m(2, 3) = 7.702713412699751;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
    ...
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = 0.655199358191179;
        m(0, 1) = -0.7015590749923188;
        m(0, 2) = 0.2802296653136303;
        m(0, 3) = -24.378695814492147;
        m(1, 0) = -0.7554560219005917;
        m(1, 1) = -0.6084550818878111;
        m(1, 2) = 0.24304035117451178;
        m(1, 3) = 36.943036725120294;
        m(2, 0) = 0.0;
        m(2, 1) = -0.3709410702804682;
        m(2, 2) = -0.928656407063011;
        m(2, 3) = -32.64950630748629;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
    ...
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = -0.12316316348384228;
        m(0, 1) = 0.47851608243384774;
        m(0, 2) = -0.8693981792095123;
        m(0, 3) = -97.68194268706864;
        m(1, 0) = -0.9684362001788849;
        m(1, 1) = -0.24926156178416892;
        m(1, 2) = 0.0;
        m(1, 3) = -93.30408292578261;
        m(2, 0) = -0.2167075479620758;
        m(2, 1) = 0.8419566691161013;
        m(2, 2) = 0.4941121390809829;
        m(2, 3) = -48.17348057895294;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
    ...
    {
        Matrix<double, 4, 4, ColumnStorage> m;
        m(0, 0) = -0.8820615884895145;
        m(0, 1) = -0.11346792289034995;
        m(0, 2) = -0.45726620757093356;
        m(0, 3) = -48.8253349197771;
        m(1, 0) = -0.12758811649101956;
        m(1, 1) = 0.9918272392560481;
        m(1, 2) = 0.0;
        m(1, 3) = 50.033634014775515;
        m(2, 0) = 0.4535290802601621;
        m(2, 1) = 0.058341734158967;
        m(2, 2) = -0.8893298687290875;
        m(2, 3) = 92.22065810812657;
        m(3, 0) = 0.0;
        m(3, 1) = 0.0;
        m(3, 2) = 0.0;
        m(3, 3) = 1.0;
